...
sqlite關聯式資料庫
SQLite關聯式資料庫-使用SQLiteStudio結合App Inventor 2實作
...
超圖解 Python 物聯網實作入門：使用 ESP8266 與 MicroPython ft797
